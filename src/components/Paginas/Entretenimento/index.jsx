...
class Entretenimento extends PureComponent {

    constructor(props) {
        super(props);
        this.state = {
            listaNoticias: [],
            classCor: "visualizar-noticia-roxo",
            categoriaId: 3,
            pagina: 1,
            totalPagina: 0,
            limite: 26,
    ...
    componentDidMount() {
        document.title = "Esporte | 24 Horas News";
        this.getPaginaUrl();
        this.getTopNoticias();
    }
    ...
    render() {
        ...
        return (
            <div className="container">
                <div className="row">
                    <div className="col-12 noticia-header cor-entretenimento">
                        <h1>Entretenimento</h1>
                        <h2>Entretenimento de Cuiabá, Mato Grosso, do Brasil e do Mundo você encontra aqui no 24 Horas News.</h2>
                    </div>
                </div>
