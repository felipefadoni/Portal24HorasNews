...
class Esporte extends PureComponent {

    constructor(props) {
        super(props);
        this.state = {
            listaNoticias: [],
            classCor: "visualizar-noticia-verde",
            categoriaId: 2,
            pagina: 1,
            totalPagina: 0,
            limite: 26,
    ...
    render() {
        ...
        return (
            <div className="container">
                <div className="row">
                    <div className="col-12 noticia-header cor-esporte">
                        <h1>Esporte</h1>
                        <h2>Esporte de Cuiabá, Mato Grosso, do Brasil e do Mundo você encontra aqui no 24 Horas News.</h2>
                    </div>
                </div>
